...
{"id": "D1", "title": "More than one machine can work the backlog", "round": "Round 1", "column": "doing", "machine": "ben-3070", "statusAuto": "tasks:9/11", "kind": "feature", "origin": "One PC is the whole workforce today, and it cannot test half of what is planned. Ben trusts a few people with the private project, so their machines should take work from the same list.", "raisedBy": "Ben", "summary": "Work can now be shared between several computers safely. Each machine records what it is, how much of its owner's allowance the project may use, whether it may publish a finished job and what it is good for; a job is claimed by one machine before any work starts, so two never pick the same one.", "status": "9 of 11 tasks done.", "repairRounds": 0, "merged": "2026-09-23 11:26", "workMinutes": 6, "tokens": 2601341, "tokensWritten": 71507,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"Claude Opus 5.5 (subagent)","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
...
{"id": "F29", "title": "Small pieces burst into cubes", "round": "Round 1", "column": "doing", "statusAuto": "tasks:0/2", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Ben, 22 September: when a small piece is shot or smashed it should burst into cube particles rather than spawn ever-smaller objects or just vanish. Fleshed out 25 September.", "raisedBy": "Ben", "summary": "A break's dust, and any small body a hard blow would have broken, bursts into a spray of little lit cubes in its own colours, which scatter, bounce and shrink away in a few seconds. Every player's game draws its own, so it costs nothing on the network.", "status": "0 of 2 tasks done.", "repairRounds": 0, "prio": 2, "involved": []},
{"id": "F29a", "title": "The cube particle system", "round": "Round 1", "column": "doing", "statusAuto": "claimed:james-3080", "dispatched": "2026-09-25 17:51", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Part of F29. Also what the main menu's voxel rain (F24) is built on.", "raisedBy": "Ben", "summary": "Thousands of small lit cubes, each its own colour, in a handful of draw calls, that show in the packaged game: capped, bouncing off the world, shrinking away. Nothing in the game uses it yet.", "status": "Claimed by James Win (RTX 3080 10GB); starting.", "parent": "F29", "blocking": ["F29b", "F24"], "prio": 2, "repairRounds": 0, "involved": []},
{"id": "F29b", "title": "Breaks and crumbs burst into cubes", "round": "Round 1", "column": "todo", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Part of F29.", "raisedBy": "Ben", "summary": "The dust a break leaves, and any body under 400 voxels that a hard enough blow lands on, bursts into cubes in its own colours, on the host and on every player's screen.", "status": "Approved: waits for F29a.", "parent": "F29", "blockedBy": ["F29a"], "blocking": ["F30"], "repairRounds": 0, "involved": []},
...
{"id": "F24b", "title": "Settle the menu rain's intensity", "round": "Round 1", "column": "backlog", "questionBlocks": "F24b itself, which is not claimable until your number is in the brief. F24 (the rain, which carries the slider) is blocked by F29a and is not merged.", "questionAsked": "2026-09-24 16:30", "questionFor": "Ben", "questionKind": "decide", "question": "Which rain intensity felt right, to bake in as the fixed value?", "kind": "qol", "origin": "Ben will say which slider setting felt right.", "raisedBy": "Ben", "summary": "Bake in Ben's chosen intensity and remove the slider.", "status": "Not claimable until the intensity is settled; that question is on the board's Needs Input list.", "repairRounds": 0, "blockedBy": ["F24"], "involved": []},

{"id": "B1e", "title": "Fast carving never drops a cut", "round": "Round 1", "column": "done", "questionBlocks": "B1e is merged, so nothing is blocked; the answer is the only thing that says whether the fix landed as intended.", "questionAsked": "2026-09-24", "questionFor": "Ben", "questionKind": "play", "question": "Play the carve: while you drag, does the body you are cutting still collide as its box, or is that gone?", "statusAuto": "merged:2026-09-24", "machine": "james-3080", "merged": "2026-09-24", "kind": "bug", "grade": "M", "origin": "B1c's test found the host silently drops a carve scoop while the previous piece's collision is still being built (20-620 ms), so quick carving loses cuts.", "raisedBy": "Ben", "summary": "Build a carved piece's collision after the piece is in place, so every scoop is carved.", "status": "Merged; every scoop is carved (20 of 20). The playtest to ask for is on the board's Needs Input list.", "parent": "B1", "blocking": [], "repairRounds": 0, "involved": [{"role": "researched", "model": "Claude Sonnet (subagent)", "machine": "james-3080"},
   {"role":"implemented","model":"Grok (grok-4.7-build)","machine":"james-3080"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"}
 ]},
...
{"id": "F23c", "title": "Menu touch-ups after the first review", "round": "Round 1", "column": "done", "questionBlocks": "F23c is merged, so nothing is blocked. F23's own record lists reopening a saved Box among the things not tested, and this is the one only you can settle.", "questionAsked": "2026-09-25", "questionFor": "Ben", "questionKind": "play", "question": "Play the menus: does a saved Box reload the way you left it?", "statusAuto": "merged:2026-09-25", "merged": "2026-09-25", "kind": "qol", "grade": "S", "origin": "Ben's answers to the questions from F23's review.", "raisedBy": "Ben", "summary": "Templates keep their name, the host's leave is a clear dialog, and a few words fixed.", "status": "Merged 2026-09-25.", "parent": "F23", "repairRounds": 0, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ], "machine": "james-3080"},
