...
{"id": "F3", "title": "See-through objects", "round": "Round 1", "column": "doing", "statusAuto": "tasks:3/5", "machine": "james-3080", "kind": "feature", "origin": "The generator (TRELLIS) works out how see-through each voxel is, but the game throws that away. Ben: \"Trellis should do see-through ok\".", "raisedBy": "Ben", "summary": "Split in two: first measure whether the see-through data is good enough to be worth keeping (F3a), then build the real feature from those numbers (F3b).", "status": "3 of 5 tasks done.", "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"}
 ]},
...
{"id": "F3b", "title": "See-through objects in the game", "round": "Round 1", "column": "doing", "statusAuto": "tasks:2/3", "machine": "james-3080", "kind": "feature", "origin": "The second half of F3.", "raisedBy": "Ben", "summary": "Glass and other see-through parts of a generated object actually look see-through. Designed from F3a's measurements.", "status": "2 of 3 tasks done.", "parent": "F3", "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"}
 ]},
