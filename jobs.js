...
{"id": "F3", "title": "See-through objects", "round": "Round 1", "column": "doing", "statusAuto": "tasks:4/5", "machine": "james-3080", "kind": "feature", "origin": "The generator (TRELLIS) works out how see-through each voxel is, but the game throws that away. Ben: \"Trellis should do see-through ok\".", "raisedBy": "Ben", "summary": "Split in two: first measure whether the see-through data is good enough to be worth keeping (F3a), then build the real feature from those numbers (F3b).", "status": "4 of 5 tasks done.", "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"}
 ]},
...
{"id": "B16", "title": "The two-player test sometimes ends with objects still arriving", "round": "Round 1", "column": "doing", "dispatched": "2026-09-26 19:00", "kind": "bug", "origin": "A run of the scripted two-player test sometimes ends with most of a crate tower still waiting to arrive, and it is not yet known whether the game lost the request or the test simply stopped waiting too early.", "raisedBy": "the team", "summary": "Either the game really does lose a request for an object, or the test is impatient. The next step is to make the test say plainly which of the two it is, and fix whichever it is.", "status": "Built; reviewed by 1 model; waiting for the orchestrator's check.", "machine": "james-3080", "statusAuto": "reviewed:1", "repairRounds": 0,
 "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"}
 ]},
...
{"id": "F31e", "title": "Chat history, a default channel and /r", "round": "Round 1", "column": "doing", "dispatched": "2026-09-26 19:00", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Up and Down in the chat box bring back what you sent. A plain line goes to your default channel (Global to start with), and typing just /dm james, or /global, switches it, with a label showing where you are talking. /r replies to the last person who messaged you.", "status": "Built; reviewed by 1 model; waiting for the orchestrator's check.", "parent": "F31", "blocking": ["F31f", "F31g"], "machine": "james-3080", "statusAuto": "reviewed:1", "repairRounds": 0, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"}
 ]},
