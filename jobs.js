...
{"id": "F31b", "title": "QA items in every brief, and a compiler", "round": "Round 1", "column": "doing", "dispatched": "2026-09-26 07:24", "kind": "feature", "grade": "M", "origin": "Part of F31. Many finished tasks end with a 'try this on the next playtest' note that nobody collects.", "raisedBy": "Ben", "summary": "A QA section in the brief format, a script that gathers every task's tests into one file that only development builds carry, and a one-off tidy-up of the existing 'for Ben to play' notes into numbered tests.", "status": "In its repair round.", "parent": "F31", "blocking": ["F31c"], "machine": "james-3080", "statusAuto": "repaired:OpenRouter stealth/space-bunny-alpha@james-3080", "repairRounds": 0, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31c", "title": "/qa-task and /qa-report (development builds only)", "round": "Round 1", "column": "todo", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Type /qa-task to be handed a random test you have not had yet; type /qa-report and the test's name, with Tab to complete it, to record your answer in your own words. Only in development builds: the shop build does not contain these commands at all.", "status": "Approved: waits for F31a and F31b.", "parent": "F31", "blockedBy": ["F31a", "F31b"], "blocking": ["F31d"], "repairRounds": 0, "involved": []},
