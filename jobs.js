...
{"id": "F31c", "title": "/qa-task and /qa-report (development builds only)", "round": "Round 1", "column": "doing", "dispatched": "2026-09-26 11:35", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Type /qa-task to be handed a random test you have not had yet; type /qa-report and the test's name, with Tab to complete it, to record your answer in your own words. Only in development builds: the shop build does not contain these commands at all.", "status": "Being built by OpenRouter stealth/space-bunny-alpha on James Win (RTX 3080 10GB).", "parent": "F31", "blocking": ["F31d"], "machine": "james-3080", "statusAuto": "building:OpenRouter stealth/space-bunny-alpha@james-3080", "repairRounds": 0, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31d", "title": "The QA triage agent", "round": "Round 1", "column": "todo", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "A Sonnet agent reads the collected QA reports, /bug and /idea files, ticks off the tests people have completed, and writes up each failure or idea as a proposed task for an orchestrator and Ben to decide on.", "status": "Approved: waits for F31c.", "parent": "F31", "blockedBy": ["F31c"], "repairRounds": 0, "involved": []},
