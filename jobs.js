...
{"id": "F10a", "title": "Growing and restoring voxels: the rules", "round": "Round 1", "column": "doing", "statusAuto": "building:OpenRouter stealth/space-bunny-alpha@ben-3070", "machine": "ben-3070", "dispatched": "2026-09-25 00:40", "kind": "feature", "grade": "M", "origin": "Part of F10.", "raisedBy": "Ben", "summary": "The exact, tested rules for adding voxels under a brush (only where they connect to the object, with two ways to colour them) and for restoring an object to what it was made as.", "status": "Being built by OpenRouter stealth/space-bunny-alpha on Ben's Win (RTX 3070 8GB).", "parent": "F10", "repairRounds": 0, "blocking": ["F10b"], "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"}
 ]},
...
{"id": "F28", "title": "Painting with opacity", "round": "Round 1", "column": "todo", "kind": "feature", "raisedBy": "Ben", "repairRounds": 0, "grade": "L", "origin": "Ben, 24 September: once you can paint something see-through you can see the layers underneath, so how do you paint those, and how do you make a see-through window on purpose?", "summary": "Paint with any opacity, down to invisible but still solid. Layers of coloured glass show through each other. Hold Alt and every brush aims through see-through voxels to what is behind; Alt and the mouse wheel move the brush deeper or nearer, shown as an x-ray ball.", "status": "Approved: waits for the colour editor (F27a) and the glass drawing (F3b3).", "blockedBy": ["F27a"], "involved": []},
