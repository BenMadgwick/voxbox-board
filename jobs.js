...
{"id": "D1", "title": "More than one machine can work the backlog", "round": "Round 1", "column": "doing", "machine": "ben-3070", "statusAuto": "tasks:9/10", "kind": "feature", "origin": "One PC is the whole workforce today, and it cannot test half of what is planned. Ben trusts a few people with the private project, so their machines should take work from the same list.", "raisedBy": "Ben", "summary": "Work can now be shared between several computers safely. Each machine records what it is, how much of its owner's allowance the project may use, whether it may publish a finished job and what it is good for; a job is claimed by one machine before any work starts, so two never pick the same one.", "status": "9 of 10 tasks done.", "repairRounds": 0, "merged": "2026-09-23 11:26", "workMinutes": 6, "tokens": 2601341, "tokensWritten": 71507,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"Claude Opus 5.5 (subagent)","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
