...
{"id": "Q3", "title": "Q flies up, E flies down", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-21", "kind": "qol", "origin": "Players wanted Q and E the other way round.", "raisedBy": "playtesters", "summary": "Q and E are swapped: Q now flies up and E flies down.", "status": "Merged together with Q4, the first job given to a small, fast model. Built and tested by script; not yet played.", "forPlaytesters": "Fly around and check it feels natural.", "repairRounds": 0, "dispatched": "2026-09-21 21:36", "merged": "2026-09-21 21:44", "workMinutes": 4, "tokens": 270481, "tokensWritten": 4395,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
...
{"id": "F3b", "title": "See-through objects in the game", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "james-3080", "kind": "feature", "origin": "The second half of F3.", "raisedBy": "Ben", "summary": "Glass and other see-through parts of a generated object actually look see-through. Designed from F3a's measurements.", "status": "2 of 3 tasks done.", "parent": "F3", "merged": "2026-09-25", "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"}
 ]},
...
{"id": "F3b4", "title": "The generator keeps the see-through data", "round": "Round 1", "column": "done", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "machine": "james-3080", "dispatched": "2026-09-25 07:27", "kind": "feature", "grade": "M", "origin": "The last part of F3b: the generator add-on currently throws the see-through numbers away, so a generated bottle arrives solid.", "raisedBy": "Ben", "summary": "The generator now keeps each voxel's see-through value and the host runs the glass rule when a generated object arrives, so a glass bottle comes out see-through without the picture being made again; opaque objects are byte-for-byte unchanged.", "status": "Merged 2026-09-26. Built and tested by script; not yet played. Known: generated glass still reads solid blue (the clear fill's many teals draw a face at every seam) -- question for Ben on the card.", "forPlaytesters": "With the generator: make a picture of a glass object (a bottle or jar). It should arrive see-through, with what is inside visible -- say whether it does, and how blue the glass looks. Opaque objects should come out exactly as before.", "parent": "F3b", "blockedBy": [], "tokens": 49162237, "tokensWritten": 219903, "workMinutes": 232, "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"},
...
{"id": "B9", "title": "Show as joinable on Steam", "round": "Round 1", "column": "done", "questionBlocks": "B9 is merged, so nothing is blocked; its status says the presence is set and read back by script, and only the other half of that -- a real friend, a real click -- is untested.", "questionAsked": "2026-09-24", "questionFor": "Ben", "questionKind": "try", "question": "With a second Steam account signed in on another PC, does your friend see the game in their friends list, and can they Join it?", "statusAuto": "merged:2026-09-24", "machine": "ben-3070", "dispatched": "2026-09-24 12:22", "kind": "bug", "grade": "M", "origin": "It looked as though Steam showed Ben offline, so friends couldn't join him. Ben later corrected this: his friends were offline, so nothing was broken. Kept as a nice-to-have.", "raisedBy": "Ben", "summary": "When you host over Steam, your friends list shows you hosting a VoxBox game with the player count, and friends get a Join game button on your profile that takes them into your game.", "status": "Merged. Presence set and read back checked by script; not tested: a friend actually clicking Join game, and the lobby search listing a game from one PC. Both need a second account: on the board's Needs Input list.", "repairRounds": 2,
 "merged": "2026-09-24 22:19", "forPlaytesters": "Host on Steam, then have a friend look at you in their Steam friends list: it should say you are hosting, with a Join game option that brings them straight in.", "workMinutes": 145, "tokens": 42939918, "tokensWritten": 563450, "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
...
{"id": "B10", "title": "Other players move smoothly", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "machine": "james-3080", "merged": "2026-09-24", "dispatched": "2026-09-24 06:13", "kind": "bug", "grade": "L", "origin": "Other players' markers moved choppily, hopping rather than gliding.", "raisedBy": "Ben", "summary": "Other players glide instead of hopping 15 times a second. The smoothing starts at 120 ms, a first guess for Ben to tune.", "status": "Merged 2026-09-24.", "repairRounds": 0,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
...
{"id": "B1c", "title": "Carves are replayed, not downloaded", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "merged": "2026-09-24", "machine": "james-3080", "dispatched": "2026-09-24 15:38", "kind": "bug", "grade": "L", "origin": "Part of B1: carving stalled joining players' games (reported as B7).", "raisedBy": "playtesters", "summary": "Joining machines repeat each carve themselves, the way they already do for breaks and paint, instead of downloading the object after every scoop.", "status": "Merged; every scoop the host carves is replayed, none downloaded (the host's own dropped scoops are B1e).", "parent": "B1", "workMinutes": 22, "repairRounds": 1,
 "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"},
   {"role":"implemented","model":"Claude Sonnet (subagent)","machine":"james-3080"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"},
...
{"id": "F7f", "title": "Glued builds stay light", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "merged": "2026-09-24 21:36", "machine": "ben-3070", "dispatched": "2026-09-24 07:53", "kind": "feature", "grade": "M", "origin": "Part of F7.", "raisedBy": "Ben", "summary": "Parts that line up exactly on the voxel grid -- the same size and material, whole quarter turns apart, whole voxels apart, and unpainted (or cut from the same object and put back where they were) -- are folded into one part when glued, so a wall of 64 crates is one part, not 64. Erase still restores exactly what was there.", "status": "Merged. Built and tested by script (64-crate wall -> 1 part, erase round-trip, all 24 turns in the unit test); the picture was looked at. Not yet played, and not yet tried between two players.", "parent": "F7", "repairRounds": 2,
 "forPlaytesters": "Glue a wall of unpainted crates (C) together: it should turn into one smooth block and feel no heavier to move. Paint one crate first and glue again: that crate stays separate. Turned crates should fold too.", "workMinutes": 413, "tokens": 93751383, "tokensWritten": 1163154, "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
...
{"id": "D1", "title": "More than one machine can work the backlog", "round": "Round 1", "column": "done", "machine": "ben-3070", "statusAuto": "merged:2026-09-23", "kind": "feature", "origin": "One PC is the whole workforce today, and it cannot test half of what is planned. Ben trusts a few people with the private project, so their machines should take work from the same list.", "raisedBy": "Ben", "summary": "Work can now be shared between several computers safely. Each machine records what it is, how much of its owner's allowance the project may use, whether it may publish a finished job and what it is good for; a job is claimed by one machine before any work starts, so two never pick the same one.", "status": "10 of 11 tasks done.", "repairRounds": 0, "merged": "2026-09-23 11:26", "workMinutes": 6, "tokens": 2601341, "tokensWritten": 71507,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"Claude Opus 5.5 (subagent)","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
...
{"id": "D2", "title": "The jobs board says which machine did what", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-23", "machine": "ben-3070", "kind": "feature", "grade": "M", "origin": "There are several machines now, but the board named only the model that researched, built and reviewed a job, so Ben could not see what each machine had been up to.", "raisedBy": "Ben", "summary": "Every piece of a job's story now names the machine as well as the model, and the board gains filters for machine and model, so you can follow one machine's work across the whole board.", "status": "Merged. The page you are reading is the result.", "repairRounds": 0, "dispatched": "2026-09-23 16:06", "merged": "2026-09-23 16:20", "workMinutes": 7, "tokens": 7465863, "tokensWritten": 65560,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"deepseek-flash","machine":"ben-3070"}
 ]},

{"id": "B16", "title": "The two-player test sometimes ends with objects still arriving", "round": "Round 1", "column": "done", "merged": "2026-09-26", "dispatched": "2026-09-26 19:00", "kind": "bug", "origin": "A run of the scripted two-player test sometimes ends with most of a crate tower still waiting to arrive, and it is not yet known whether the game lost the request or the test simply stopped waiting too early.", "raisedBy": "the team", "forPlaytesters": "Nothing changes in the game: this is the two-player test's own reading.", "summary": "The test was impatient, not the game: the crate object lands 0.3-0.9 s after it is asked for, but the host's warm-up takes 10-23 s with two games on one PC, and the old reading was taken 5 s after the ask. The client now watches the ask for up to 30 s and says whether it landed (and when) or never arrived; the host logs the ask and the send, and plain net_test finally has a verdict. The client's screenshot is poor now (a body right in front of the camera) and may want a later moment.", "status": "Merged 2026-09-26.", "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 12858694, "tokensWritten": 81223, "workMinutes": 65, "repairRounds": 1,
 "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
...
{"id": "F22e", "title": "The link between the game and the Dedicated app", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "machine": "ben-3070", "merged": "2026-09-24", "kind": "feature", "grade": "M", "origin": "Part of F22.", "raisedBy": "Ben", "summary": "A small, tested way for the game and the Dedicated app to talk, on one PC, over a home network or through Steam.", "forPlaytesters": "Nothing visible yet: the language the game and VoxBox Dedicated will speak.", "status": "Merged. Tested by script (unit tests, fuzzed); nothing to see yet -- F22g puts it to work.", "parent": "F22", "tokens": 8729573, "tokensWritten": 184732, "workMinutes": 26, "repairRounds": 1,
 "involved": [
   {"role":"researched","model":"Claude Opus (subagent)","machine":"ben-3070"},
   {"role":"implemented","model":"deepseek-flash","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
...
{"id": "F22f", "title": "Try the Steam side on a test app", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "machine": "ben-3070", "dispatched": "2026-09-24 02:34", "kind": "feature", "grade": "R", "origin": "Part of F22.", "raisedBy": "Ben", "summary": "A test of what Steam gives a dedicated server: players can connect to it directly and prove they own the game, and a megabyte goes each way fine -- but a server without its own Steam login is never listed, so finding one needs a different plan.", "status": "Merged (a spike; nothing changes in the game). The open question is on the board's Needs Input list.", "parent": "F22", "repairRounds": 0, "blocking": [],
...
{"id": "F22c", "title": "Hosting works the same with no player at the host", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "merged": "2026-09-24", "dispatched": "2026-09-24 15:00", "machine": "james-3080", "kind": "feature", "grade": "L", "origin": "Part of F22: F22b's test found three places where the host assumed it had a player.", "raisedBy": "Ben", "summary": "Breaks and glue are announced by any host, host-run tests need no host player, and the host can lend its own GPU; every two-player test then passes with a host that has no player.", "status": "Approved; for James's Grok worker (james-3080).", "parent": "F22", "repairRounds": 1, "tokens": 32170708, "tokensWritten": 128640, "workMinutes": 88, "prio": 2, "blocking": [], "involved": [{"role": "researched", "model": "Claude Opus (orchestrator)", "machine": "ben-3070"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"},
...
{"id": "F23", "title": "A main menu, and a menu on Escape", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "merged": "2026-09-24", "machine": "james-3080", "dispatched": "2026-09-24 19:10", "kind": "feature", "origin": "Ben, 24 September: stacked buttons like Minecraft's -- Single Player (choose a map, you host from then on), Multiplayer (join friends' lobbies), Options, Exit Game; Escape in game: Options, Exit Lobby, Exit Game.", "raisedBy": "Ben", "summary": "The game opens on a menu: Single Player (a new Box or one of your saved Boxes; you host from the first frame), Multiplayer (friends' games), Options, Exit Game. Escape opens a pause menu (Resume, Options, Exit Lobby, Exit Game); Tab alone frees the mouse. When the host leaves, the Box is saved and everyone goes back to their menu with \"The host has closed the Box\". \"Box\", not \"table\", in everything a player reads.", "status": "Merged. Built and tested by script (menu and pause screenshots, a client sent back to its menu, the save on disk); not yet played. Not tested: reopening a saved Box, the Escape key itself, the Steam friends list.", "forPlaytesters": "Start the game: the menu. Single Player -> Default -> New Box, put things down, Escape -> Exit Lobby (click twice), then reopen that Box: things come back grouped in the middle, not exactly where they were. With a friend: Multiplayer should list your game while you host; when you leave, they are sent to their menu.", "workMinutes": 140, "repairRounds": 0, "involved": [
   {"role":"implemented","model":"Claude Sonnet (subagent)","machine":"james-3080"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"}
 ]},
...
{"id": "F25", "title": "Pick out parts of an object", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "ben-3070", "dispatched": "2026-09-25 06:20", "kind": "feature", "grade": "L", "origin": "Ben, 24 September: a generated dinner table comes as one object; he wants to pick out a wine glass, keep it on its own, or make it a separate part of the table that can be glass while the table stays wood.", "raisedBy": "Ben", "summary": "A Parts tool: hover to light up the parts of an object, click to pick one, or select voxels with a colour wand (drag up and down to grow or shrink it) or a ball or cube brush, Shift to add and Ctrl to remove. Then keep the selection as its own library object, make it a separate part in place (nothing visibly changes), or give a part its own material so it breaks like glass, wood or metal.", "status": "Merged 2026-09-25.", "tokens": 52928903, "tokensWritten": 368200, "workMinutes": 172, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"}
 ]},
{"id": "F26", "title": "Parts that move", "round": "Round 1", "column": "todo", "kind": "feature", "grade": "L", "origin": "Ben, 24 September: once an object has parts, they could move: a glass that topples, a lid that opens, crude limbs on a character.", "raisedBy": "Ben", "summary": "Parts of an object can rotate, slide and scale (scaled to nothing, a part hides), driven by time, by a use key, or left to physics like a hinge. Parts can hang from other parts, so an arm moves its hand. Saved with the object, so it still moves when thrown out of the library.", "status": "Approved: waits for Parts (F25) and saving glued builds (F7k).", "repairRounds": 0, "blockedBy": ["F7k"], "involved": []},
{"id": "F10", "title": "Sculpt: carve, grow and restore", "round": "Round 1", "column": "done", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "machine": "james-3080", "kind": "feature", "grade": "L", "origin": "Ben, 24 September: he wanted the opposite of carve, adding voxels to an object, and then a way to put an object back how it was made.", "raisedBy": "Ben", "summary": "The carve tool becomes Sculpt: left button carves as now, right button grows the object where you point (in the paint colour, or copying the colour next to it), and Ctrl with the right button restores it towards the way it was made, shape and colour. Grown voxels only join on to what is already there, so nothing floats loose.", "status": "Merged 2026-09-26: all three tasks done.", "merged": "2026-09-26", "repairRounds": 0, "involved": []},
{"id": "F10a", "title": "Growing and restoring voxels: the rules", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-25", "machine": "ben-3070", "merged": "2026-09-25", "kind": "feature", "grade": "M", "origin": "Part of F10.", "raisedBy": "Ben", "summary": "Grow adds voxels under a brush only where they join the object, in a chosen colour or copying their neighbours; Restore puts an object back to how it was made, shape and colour. The same result on every machine, tested with no game running.", "status": "Merged 2026-09-25. Rules only: nothing to play until F10b and F10c put it in the game.", "parent": "F10", "repairRounds": 0, "workMinutes": 48, "tokens": 3182281, "tokensWritten": 144501, "involved": [
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"ben-3070"}
 ]},
{"id": "F10b", "title": "Growing and restoring in the game and on friends' screens", "round": "Round 1", "column": "done", "forPlaytesters": "Growing and restoring now work in a shared game: what one player grows or restores appears on everyone's screen, joins the object's collision, and keeps the colour and see-through amount of the swatch you picked. The Sculpt tool itself comes with F10c, so this is mostly for the demo and two-player tests until then.", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "machine": "james-3080", "dispatched": "2026-09-25 05:46", "kind": "feature", "grade": "L", "origin": "Part of F10.", "raisedBy": "Ben", "summary": "The host grows or restores an object in place without it jumping or dropping quick strokes, and everyone else's copy follows exactly, including objects made of several parts.", "status": "Merged 2026-09-26: built by Space Bunny; Grok review found grows dropping the swatch's see-through value, a collision rebuild race and a demo that skipped the host (all real), repaired by Space Bunny; tests, unity build and the two-player grow test re-run by the orchestrator on the merged tree. Shots looked at: the restore reads well; the blob shot is framed too close to judge.", "parent": "F10", "tokens": 79767629, "tokensWritten": 393270, "workMinutes": 251, "repairRounds": 2, "blockedBy": [], "blocking": [""], "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
...
{"id": "F10c", "title": "The Sculpt tool", "round": "Round 1", "column": "done", "merged": "2026-09-26", "dispatched": "2026-09-26 12:19", "kind": "feature", "grade": "S", "origin": "Part of F10.", "raisedBy": "Ben", "summary": "The carve tool is renamed Sculpt with its buttons: left carves, right grows, Ctrl and right restores; a key chooses how grown voxels are coloured; the cursor and the hints show which action you have.", "status": "Merged 2026-09-26: built by Space Bunny; Grok review found the cursor kept the grow/restore look after the right button was let go, the demo counting around the wrong cell, and a stray fill byte on carve and restore (all real), repaired by Space Bunny; the four cursor and overlay shots looked at by the orchestrator at 2560x1080 and 1280x720 (everything fits; at 720 the H panel's Sculpt column ends just short of Panels).", "forPlaytesters": "Press 6 for Sculpt. Left button carves, right button grows voxels on where you point, and Ctrl held as you press the right button restores the object towards how it was made. F switches what a grow fills with: your paint colour, or the colour of the voxel next to it. The brush cursor shows which one you are about to do: solid orange for carve, a ring in the paint colour for grow (grey when it copies the nearest colour), pale blue for restore. After a grow or restore, let go and check the cursor goes back to carve. H shows all the Sculpt keys.", "parent": "F10", "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 31059797, "tokensWritten": 141674, "workMinutes": 67, "repairRounds": 2, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
...
{"id": "F27b", "title": "The colour dropper", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "james-3080", "dispatched": "2026-09-25 12:33", "kind": "feature", "raisedBy": "Ben", "tokens": 18333693, "tokensWritten": 115961, "workMinutes": 42, "repairRounds": 0, "grade": "S", "origin": "Part of F27.", "summary": "A pipette button in the colour editor: click it, then click anything. A voxel gives its exact colour and see-through amount; anything else gives the colour on screen.", "status": "Merged 2026-09-25.", "parent": "F27", "blockedBy": [], "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F28", "title": "Painting with opacity", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-25", "merged": "2026-09-25", "kind": "feature", "raisedBy": "Ben", "repairRounds": 0, "grade": "L", "origin": "Ben, 24 September: once you can paint something see-through you can see the layers underneath, so how do you paint those, and how do you make a see-through window on purpose?", "summary": "Paint with any opacity, down to invisible but still solid. Layers of coloured glass show through each other. Hold Alt and every brush aims through see-through voxels to what is behind; Alt and the mouse wheel move the brush deeper or nearer, shown as an x-ray ball.", "status": "Merged 2026-09-25.", "blockedBy": [], "involved": []},
{"id": "F28a", "title": "Paint with opacity", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-25", "machine": "james-3080", "merged": "2026-09-25", "kind": "feature", "raisedBy": "Ben", "tokens": 17617027, "tokensWritten": 119609, "workMinutes": 33, "repairRounds": 0, "grade": "M", "origin": "Part of F28.", "summary": "Paint uses the chosen swatch's opacity, on your screen and on everyone else's exactly; erase still brings the original back.", "status": "Merged 2026-09-25.", "parent": "F28", "blockedBy": [], "blocking": [], "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F28b", "title": "Draw layered and invisible glass", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "ben-3070", "dispatched": "2026-09-25 01:27", "kind": "feature", "raisedBy": "Ben", "tokens": 8428499, "tokensWritten": 104548, "workMinutes": 68, "repairRounds": 0, "grade": "M", "origin": "Part of F28. Meant to be folded into F3b3, which was already being built.", "summary": "Red glass painted over blue shows both colours, and voxels painted fully clear are not drawn at all, while still solid.", "status": "Merged. The glass was missing from its pictures only because they were taken before the game had finished preparing its shaders; every scripted picture now waits for that.", "parent": "F28", "involved": [
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"ben-3070"}
 ]},
{"id": "F28c", "title": "Aim through glass and at depth", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "james-3080", "dispatched": "2026-09-25 13:23", "kind": "feature", "raisedBy": "Ben", "tokens": 22419463, "tokensWritten": 165325, "workMinutes": 45, "repairRounds": 0, "grade": "M", "origin": "Part of F28.", "summary": "Hold Alt and paint, erase or carve aim through see-through voxels to the first solid one; Alt and the wheel move the brush a voxel deeper or nearer, shown as an x-ray ball with the depth beside the crosshair.", "status": "Merged 2026-09-25.", "parent": "F28", "blockedBy": [], "involved": [
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
...
{"id": "D6", "title": "The board says where each job stands, by itself", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "merged": "2026-09-24 22:50", "machine": "ben-3070", "dispatched": "2026-09-24 15:56", "kind": "feature", "grade": "S", "origin": "Card statuses went stale because they were written by hand.", "raisedBy": "Ben", "summary": "The jobs board keeps each card's one-line status up to date by itself -- who has a job, who is building it, whether it is in review or merged -- instead of relying on someone to edit it.", "status": "Merged. Run against the real board; a second run changes nothing.", "parent": "D1", "repairRounds": 1, "forPlaytesters": "Nothing to play: the board should now say truthfully where each job is.", "workMinutes": 40, "tokens": 12392421, "tokensWritten": 322810, "involved": [
   {"role":"implemented","model":"deepseek-flash","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
   {"role":"repaired","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
...
{"id": "D7", "title": "A machine can ask a question and wait for the answer", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "ben-3070", "dispatched": "2026-09-24 16:27", "kind": "feature", "grade": "M", "origin": "James's unattended machine got stuck on a decision only Ben could make, and nobody would have known.", "raisedBy": "Ben", "summary": "A stuck machine now asks its question where Ben sees it (a Needs Input badge on the board, first in every status pass), waits without retrying, and carries on with the answer as its next session's first job, once. Workers can no longer start orchestrators.", "status": "Merged 2026-09-25. Tooling only; the board's Needs Input badge is not yet seen on a real question.", "parent": "D1", "repairRounds": 2, "workMinutes": 98, "tokens": 22663619, "tokensWritten": 292946, "prio": 2, "involved": [
   {"role":"implemented","model":"deepseek-flash","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
...
{"id": "F29", "title": "Small pieces burst into cubes", "round": "Round 1", "column": "done", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Ben, 22 September: when a small piece is shot or smashed it should burst into cube particles rather than spawn ever-smaller objects or just vanish. Fleshed out 25 September.", "raisedBy": "Ben", "summary": "A break's dust, and any small body a hard blow would have broken, bursts into a spray of little lit cubes in its own colours, which scatter, bounce and shrink away in a few seconds. Every player's game draws its own, so it costs nothing on the network.", "status": "Merged 2026-09-26.", "repairRounds": 0, "merged": "2026-09-26", "prio": 2, "involved": []},
{"id": "F29a", "title": "The cube particle system", "round": "Round 1", "column": "done", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "dispatched": "2026-09-25 17:51", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Part of F29. Also what the main menu's voxel rain (F24) is built on.", "raisedBy": "Ben", "summary": "Thousands of small lit cubes, each its own colour, in a handful of draw calls, that show in the packaged game: capped, bouncing off the world, shrinking away. Nothing in the game uses it yet.", "status": "Merged 2026-09-26.", "parent": "F29", "prio": 2, "repairRounds": 0, "repairRounds": 1, "involved": [{"role":"implemented","model":"Claude Sonnet (subagent)","machine":"james-3080"},{"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"},{"role":"repaired","model":"Claude Sonnet (subagent)","machine":"james-3080"}]},
{"id": "F29b", "title": "Breaks and crumbs burst into cubes", "round": "Round 1", "column": "done", "merged": "2026-09-26", "dispatched": "2026-09-25 23:48", "machine": "james-3080", "kind": "feature", "grade": "M", "origin": "Part of F29.", "raisedBy": "Ben", "summary": "The dust a break leaves, and any body under 400 voxels that a hard enough blow lands on, bursts into cubes in its own colours, on the host and on every player's screen.", "status": "Merged 2026-09-26.", "parent": "F29", "statusAuto": "merged:2026-09-26", "tokens": 39107337, "tokensWritten": 175018, "workMinutes": 70, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F30", "title": "Try Niagara for the cube bursts", "round": "Round 1", "column": "backlog", "kind": "feature", "grade": "R", "origin": "Ben, 25 September: keep the simple cube system for now, but keep a follow-up to check whether Unreal's own particle system (Niagara) could replace it later.", "raisedBy": "Ben", "summary": "A measured test of whether Niagara could draw the cube bursts instead, handling many more cubes for less, and whether sound hooks and the menu rain still work. Nothing changes in the game; it ends with a recommendation.", "status": "Parked: Ben may not schedule it for some time, as the cube system may be enough.", "repairRounds": 0, "involved": []},
{"id": "F31", "title": "Chat channels and QA testing from inside the game", "round": "Round 1", "column": "doing", "statusAuto": "tasks:6/7", "kind": "feature", "grade": "M", "origin": "Ben, 25 September: more commands in the in-game chat, specifically a way to be handed a test to try, report back in his own words, and have those reports triaged.", "raisedBy": "Ben", "summary": "Chat gets channels (Global, DM, Local, groups, QA Test, QA Report), /dm, /local, groups with admins, Up/Down history, a default channel you switch with a bare command, tab completion and a truthful /help. Development builds get /qa-task, which hands you one small test at a time, and /qa-report, which stores your answer for a Sonnet agent to triage into ticked-off tests and new tasks.", "status": "6 of 7 tasks done.", "machine": "ben-3070", "repairRounds": 0, "involved": []},
{"id": "F31a", "title": "Chat channels, /dm, tab completion and /help", "round": "Round 1", "column": "done", "forPlaytesters": "Chat has channels now: each kind of line (Global, DM, Bug, Idea, System, QA) has its own coloured tag. /dm <name> <message> sends a private line to one player, and Tab completes commands and names. Try /dm with a name that is not online, and /dm with a name but no message: both should tell you, and send nothing.", "merged": "2026-09-26", "dispatched": "2026-09-26 07:24", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Every chat line gets a coloured prefix (Global, DM, QA Test, QA Report, BUG, IDEA). /dm sends a private message to one player, with tab completion of names. /bug and /idea now stay private to the player and the developers. Commands ignore case, and /help or /h lists only the commands your build has.", "summary": "Chat gets a table of commands, seven kinds of line each with its own tag, private /dm lines resolved and checked by the host, and Tab completion of commands and names.", "status": "Merged 2026-09-26: built by Space Bunny; Grok review found a /dm with no message dropped in silence and an unsanitised name echoed by the host (both real), repaired by Space Bunny; shot looked at by the orchestrator.", "parent": "F31", "blocking": [""], "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 26789344, "tokensWritten": 147047, "workMinutes": 64, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31b", "title": "QA items in every brief, and a compiler", "round": "Round 1", "column": "done", "forPlaytesters": "Nothing changes in the game you play. Development builds now carry a list of short hands-on tests, one set per change, for the /qa commands that come with F31c.", "merged": "2026-09-26", "dispatched": "2026-09-26 07:24", "kind": "feature", "grade": "M", "origin": "Part of F31. Many finished tasks end with a 'try this on the next playtest' note that nobody collects.", "raisedBy": "Ben", "summary": "A QA section in the brief format, a script that gathers every task's tests into one file that only development builds carry, and a one-off tidy-up of the existing 'for Ben to play' notes into numbered tests.", "summary": "Every brief that changes what a player can do or see now carries a QA section: short plain-English tests. tools/qa_compile.ps1 gathers them into Content/QA/qa.json, which ships in Development builds and never in Shipping; orch_status checks it is up to date.", "status": "Merged 2026-09-26: built by Space Bunny; Grok review found a packaging bug and a wiring bug (both real), repaired by Space Bunny and checked by the orchestrator.", "parent": "F31", "blocking": [""], "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 14050603, "tokensWritten": 95742, "workMinutes": 26, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31c", "title": "/qa-task and /qa-report (development builds only)", "round": "Round 1", "column": "done", "forPlaytesters": "Development builds only: type /qa-task to be handed a short test you have not had before, then /qa-report followed by what happened (Tab offers the tests you were given). Reports stay on your own PC for the developers.", "merged": "2026-09-26", "dispatched": "2026-09-26 11:35", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Type /qa-task to be handed a random test you have not had yet; type /qa-report and the test's name, with Tab to complete it, to record your answer in your own words. Only in development builds: the shop build does not contain these commands at all.", "status": "Merged 2026-09-26: built by Space Bunny; Grok review found Tab after /qa-report empty in a new session (real), repaired by Space Bunny; qa.png looked at by the orchestrator: a long QA line wraps mid-word and repeats its tag (chat wrapping, a follow-up).", "parent": "F31", "blocking": [""], "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 34200043, "tokensWritten": 159841, "workMinutes": 79, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31d", "title": "The QA triage agent", "round": "Round 1", "column": "done", "merged": "2026-09-26", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "tools/qa_triage.ps1 reads a folder of collected QA reports and /bug and /idea lines, hands the new ones to an agent as data, and keeps docs/round/qa/: which lines it has read, each test's state, one file per finding for a person to turn into a task, and a one-line summary orch_status prints. A free stub rule tests the plumbing and may not write the shared ledger. Not yet run with the real agent (Ben's check: no key on james-3080).", "forPlaytesters": "Nothing changes in the game. Your /qa-report answers and /bug lines are what this reads, once they are collected.", "status": "Merged 2026-09-26.", "parent": "F31", "machine": "james-3080", "tokens": 27610371, "tokensWritten": 162900, "workMinutes": 43, "statusAuto": "merged:2026-09-26", "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
{"id": "F31e", "title": "Chat history, a default channel and /r", "round": "Round 1", "column": "done", "merged": "2026-09-26", "dispatched": "2026-09-26 19:00", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "forPlaytesters": "Press Up in the chat box to get your last line back. Type /dm and a name on its own, and plain lines go to them privately until you type /global; the label beside the box says who you are talking to. /r replies to whoever last messaged you.", "summary": "Up and Down in the chat box bring back what you sent, and the half-typed line comes back at the end. A plain line goes to your default channel (Global to start with); /dm james or /global alone switches it, /r alone switches to whoever last messaged you, and a 'To:' label beside the box says where you are talking. When your partner leaves, it goes back to Global at once and says so.", "status": "Merged 2026-09-26.", "parent": "F31", "blocking": [""], "machine": "james-3080", "statusAuto": "merged:2026-09-26", "tokens": 28814137, "tokensWritten": 144221, "workMinutes": 67, "repairRounds": 1, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"repaired","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
...
{"id": "F24b", "title": "Settle the menu rain's intensity", "round": "Round 1", "column": "backlog", "kind": "qol", "origin": "Ben will say which slider setting felt right.", "raisedBy": "Ben", "summary": "Bake in Ben's chosen intensity and remove the slider.", "status": "Waits for F24: the intensity question was withdrawn until there is a slider to try (Ben, 25 Sep).", "questionKind": "play", "questionFor": "Ben", "questionAsked": "2026-09-26 07:17", "questionBlocks": "F24b (bake the value in, remove the slider); nothing else", "question": "F24 is merged: play the main menu, move the Rain slider (bottom right, 0-10), and say which number felt right so F24b can bake it in. Also: falling cubes leave smeared trails (F29a's break dust too; a per-instance velocity fix did not cure it) -- do they bother you enough to chase?", "repairRounds": 0, "involved": []},
...
{"id": "D13", "title": "The board writes itself: new cards, merge fields, blocking links both ways", "round": "Round 1", "column": "done", "forPlaytesters": "Nothing changes in the game. The jobs board should stop showing stale 'blocked by' links.", "merged": "2026-09-26", "statusAuto": "merged:2026-09-26", "machine": "ben-3070", "dispatched": "2026-09-25 23:43", "kind": "feature", "grade": "M", "origin": "Cards for new tasks, merge details and blocked-by links were kept by hand and drifted: fourteen stale blocking links were found on 25 September.", "raisedBy": "Ben", "summary": "The board now keeps itself up to date: a card appears for every new brief, a merged card gets its effort from the ledger, and a blocking link is always written on both tasks and removed by itself when the blocking task finishes (tools/links.ps1).", "status": "Merged 2026-09-26.", "parent": "D1", "tokens": 26588712, "tokensWritten": 148334, "workMinutes": 44, "prio": 2, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"}
 ]},
{"id": "D9", "title": "Automatic Lite mode: a machine switches its own usage mode", "round": "Round 1", "column": "done", "forPlaytesters": "Nothing changes in the game.", "merged": "2026-09-26", "dispatched": "2026-09-26 00:30", "kind": "feature", "grade": "M", "origin": "Ben, 25 September: Lite mode was switched on by hand, late; the thresholds were ben-3070#15's suggestion, approved by Ben.", "raisedBy": "Ben", "summary": "Each machine now decides its own usage mode from its Claude figures -- Lite when the 5-hour window runs low, the week falls behind pace or drops under 15%, Minimal under 5% -- and the owner's word still wins. An Orca left stuck at a usage cap is noticed and replaced.", "status": "Merged 2026-09-26.", "parent": "D1", "machine": "ben-3070", "statusAuto": "merged:2026-09-26", "tokens": 10423856, "tokensWritten": 72181, "workMinutes": 18, "prio": 2, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"}
 ]},

{"id": "D12", "title": "Needs Input: one list of everything waiting on a person", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "machine": "ben-3070", "dispatched": "2026-09-25 18:09", "kind": "feature", "grade": "M", "origin": "Only formal questions got a badge; rulings, playtests and checks to write with Ben sat in card statuses and went stale.", "raisedBy": "Ben", "summary": "Every wait becomes a question with a kind (decide, play, write, try) and who may answer; a Needs Input tab lists them oldest first with what each blocks, marked stale after 2 days.", "status": "Merged 2026-09-25.", "parent": "D1", "tokens": 24406223, "tokensWritten": 109377, "workMinutes": 26, "prio": 2, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"}
 ]},

{"id": "D11", "title": "The board shows only top-level jobs, each placed by its tasks", "round": "Round 1", "column": "done", "merged": "2026-09-25", "statusAuto": "merged:2026-09-25", "dispatched": "2026-09-25 17:09", "kind": "feature", "grade": "M", "origin": "A parent and its children each had a card, so the same work looked like several jobs and In progress showed 9 when 4 things were really going on.", "raisedBy": "Ben", "summary": "Only top-level jobs get cards; a parent moves by the state of every task beneath it, and a coloured bar shows how many are done, in progress, to do and parked.", "status": "Merged 2026-09-25. Reviewed on James's PC; one rule added at merge: a parent that shipped work of its own stays done.", "parent": "D1", "repairRounds": 0, "tokens": 8493579, "tokensWritten": 59636, "workMinutes": 11, "prio": 2, "machine": "james-3080", "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"}
 ]},
...
{"id": "F23c", "title": "Menu touch-ups after the first review", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-25", "merged": "2026-09-25", "kind": "qol", "grade": "S", "origin": "Ben's answers to the questions from F23's review.", "raisedBy": "Ben", "summary": "Templates keep their name, the host's leave is a clear dialog, and a few words fixed.", "status": "Merged 2026-09-25.", "parent": "F23", "tokens": 15139381, "tokensWritten": 62763, "workMinutes": 51, "repairRounds": 0, "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ], "machine": "james-3080"},

{"id": "C1", "title": "Fill for a selection -- a colour, or one channel, for every selected voxel", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Ben's notes, from the chat: - \"We could import a stained glass window, and TRELLIS2 hopefully does it right, but if it doesn't, we can paint the red bits alpha red and the green bits alpha green.\" - \"Maybe we even make it a thing that you can select a bunch of voxels and just change their Alpha or Red channel, like a Smart Fill option for selected areas. Just select all the glass areas and then toggle their alpha to half.\" - \"Choose the Smart Select wand, hold Ctrl and click all the window bits, then adjust their alpha. The only part of that not working now is adjusting individual channels of a selection.\" - Which channels: \"all of them, I guess.\" - \"Select a bunch of pieces, then select Fill and either set them all to a colour, or just adjust an individual channel for them all. Maybe we adjust Alpha and they all now have 0.2 alpha: they keep their original colours but we see through them. Or maybe we increase Green for all of them and it looks a bit Matrix-y.\"", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},
...
{"id": "D14", "title": "parents show their size and their models, bars carry counts, and closing goes up a level", "round": "Round 1", "column": "done", "forPlaytesters": "Nothing changes in the game. On the jobs board, a parent card now shows how many tasks sit in each state, the tokens spent under it and which models worked on it; closing a dialog goes up one level.", "merged": "2026-09-26", "dispatched": "2026-09-26 09:09", "kind": "feature", "grade": "M", "origin": "Ben navigates the board by parents. Four things get in his way:", "raisedBy": "Ben", "machine": "james-3080", "summary": "A parent card and its dialog add up the work under them: a numbered state bar, the tokens spent (\"so far\" while anything is unmerged) and every model that touched it, with \"only\" when there was one. X and Escape close a dialog one level at a time.", "status": "Merged 2026-09-26: built by Space Bunny, reviewed by Grok (one real finding, fixed by the orchestrator), board_check passes.", "statusAuto": "merged:2026-09-26", "tokens": 7625570, "tokensWritten": 82748, "workMinutes": 22, "repairRounds": 0,
 "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"}
...
{"id": "D15", "title": "a task's card and dialog carry what a parent's do; Done never says \"needs\"; counts count tasks", "round": "Round 1", "summary": "Every job, task or parent, shows its models as chips and every machine that had a hand in it, a claim handed over included. A merged job never says it is being built or needs input, and the tab numbers count tasks rather than cards, filters included.", "forPlaytesters": "Nothing changes in the game. On the jobs board, every card shows its models and machines the same way, finished cards stop asking for input, and the numbers on the tabs count tasks.", "column": "done", "merged": "2026-09-26", "dispatched": "2026-09-26 18:47", "kind": "feature", "grade": "M", "origin": "", "raisedBy": "Ben", "machine": "james-3080", "status": "Merged 2026-09-26.", "statusAuto": "merged:2026-09-26", "handedFrom": "ben-3070", "tokens": 8779182, "tokensWritten": 62063, "workMinutes": 21, "repairRounds": 0,
 "involved": [
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"ben-3070"},
   {"role":"reviewed","model":"Grok (grok-4.5)","machine":"james-3080"}
 ]},

{"id": "C10", "title": "Joints and forces (TOTK-style crafting)", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Ben's goal: crafting like Zelda: Tears of the Kingdom. Half there: the animation task lets a compound (.vxc) define a physics hinge, so a small hinge object joined on each side to two other objects simulates a joint -- first make sure that works end to end. Missing: forces -- torque on a hinge to drive a wheel, a steady push for a rocket. That is what to discuss.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C11", "title": "Jobs board: projects", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Make the jobs board multi-project: VoxBox becomes one project, so DevNet can take on new projects and manage them separately on the same board.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C12", "title": "Regression tests from finished tasks", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "When a task is done, the in-game check its agents ran to prove it worked goes into a regression-test database. Simple ones run automatically now and then; complicated ones an agent runs. Catches bugs that new systems cause in old ones.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C13", "title": "Every system driveable by agents", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Make sure every menu, option and tool in VoxBox can be driven by agents or automated scripts (as the -VoxDemo modes do for some today), since agents implement and test almost everything, and regression testing needs it most.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C14", "title": "Docs and a wiki", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Document everything: first so agents can find solutions fast, later for players who want to do clever things with VoxBox, perhaps as a hosted wiki.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C15", "title": "Logos and intro animation", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Studio: Orca Studios (or simply Orca). Its logo: a pixelated whale breaching a sea of cubes; in the intro it hangs briefly, then lands and splashes cubes over the whole screen, transitioning to the VoxBox logo -- a cube like the jobs board's but leaned forward into a V shape -- then the main menu.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C4", "title": "DevNet expansion", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "DevNet is Ben's name for the distributed worker network: Orcas, subagents, workers on several machines. Review its logistics after a week of running: easier deployment on Windows and Linux (once Sam fixes onboarding); permissions and authority (e.g. James counted by agents as the same authority as Ben -- what would that mean, and is it James's Claude that carries it?); Orca efficiency and optimisations learnt from the first week. To be discussed with Ben.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C5", "title": "Claude cloud compute", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Ben has been given $100 of credit for Claude cloud compute. Find out exactly what it is (which product, what it runs, limits, expiry) and how DevNet could use it well -- e.g. cloud Claude sessions as extra workers or reviewers.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C6", "title": "Unraid server for DevNet", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "Ben's always-on Unraid server (built for media, ~60 TB free) as a DevNet resource: host the jobs board, assemble and distribute builds automatically, and be the endpoint that in-game features such as /bug phone home to. A big discussion: security, what runs there, and what stays on the PCs.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C7", "title": "Lua scripting in VoxBox", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "James's idea: Lua scripting inside VoxBox. Ben to flesh out what players or makers would script, and how it fits the host-authoritative net model.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},

{"id": "C8", "title": "Terrain", "round": "Round 1", "column": "concepts", "kind": "concept", "origin": "Ben's own idea, kept as he said it, parked until he is ready to flesh it out.", "raisedBy": "Ben", "summary": "The game needs terrain. Preferably voxel terrain, but test performance first (size, meshing, collision, networking) and decide from the numbers.", "status": "Open: not designed yet.", "repairRounds": 0,
 "involved": []},
