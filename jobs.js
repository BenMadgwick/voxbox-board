...
{"id": "F28", "title": "Painting with opacity", "round": "Round 1", "column": "doing", "kind": "feature", "raisedBy": "Ben", "repairRounds": 0, "grade": "L", "origin": "Ben, 24 September: once you can paint something see-through you can see the layers underneath, so how do you paint those, and how do you make a see-through window on purpose?", "summary": "Paint with any opacity, down to invisible but still solid. Layers of coloured glass show through each other. Hold Alt and every brush aims through see-through voxels to what is behind; Alt and the mouse wheel move the brush deeper or nearer, shown as an x-ray ball.", "status": "Approved: waits for the colour editor (F27a) and the glass drawing (F3b3).", "blockedBy": ["F27a"], "involved": []},
...
{"id": "F28c", "title": "Aim through glass and at depth", "round": "Round 1", "column": "doing", "statusAuto": "reviewed:1", "machine": "james-3080", "dispatched": "2026-09-25 13:23", "kind": "feature", "raisedBy": "Ben", "repairRounds": 0, "grade": "M", "origin": "Part of F28.", "summary": "Hold Alt and paint, erase or carve aim through see-through voxels to the first solid one; Alt and the wheel move the brush a voxel deeper or nearer, shown as an x-ray ball with the depth beside the crosshair.", "status": "Built; reviewed by 1 model; waiting for the orchestrator's check.", "parent": "F28", "blockedBy": ["F28a"], "involved": [
   {"role":"reviewed","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"},
   {"role":"implemented","model":"OpenRouter stealth/space-bunny-alpha","machine":"james-3080"}
 ]},
