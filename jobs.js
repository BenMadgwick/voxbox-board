...
{"id": "D1", "title": "More than one machine can work the backlog", "round": "Round 1", "column": "doing", "statusAuto": "tasks:8/10", "kind": "feature", "origin": "One PC is the whole workforce today, and it cannot test half of what is planned. Ben trusts a few people with the private project, so their machines should take work from the same list.", "raisedBy": "Ben", "summary": "Work can now be shared between several computers safely. Each machine records what it is, how much of its owner's allowance the project may use, whether it may publish a finished job and what it is good for; a job is claimed by one machine before any work starts, so two never pick the same one.", "status": "8 of 10 tasks done.", "repairRounds": 0, "merged": "2026-09-23 11:26", "workMinutes": 6, "tokens": 2601341, "tokensWritten": 71507,
 "involved": [
   {"role":"researched","model":"Claude Opus (orchestrator)","machine":"ben-3070"},
   {"role":"implemented","model":"Claude Opus 5.5 (subagent)","machine":"ben-3070"},
   {"role":"reviewed","model":"deepseek-flash","machine":"ben-3070"},
...
{"id": "F22f", "title": "Try the Steam side on a test app", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "machine": "ben-3070", "dispatched": "2026-09-24 02:34", "kind": "feature", "grade": "R", "origin": "Part of F22.", "raisedBy": "Ben", "summary": "A test of what Steam gives a dedicated server: players can connect to it directly and prove they own the game, and a megabyte goes each way fine -- but a server without its own Steam login is never listed, so finding one needs a different plan.", "status": "Merged (a spike; nothing changes in the game). Needs Ben to choose how servers are found: a Steam login token per server, or Steam lobbies.", "parent": "F22", "repairRounds": 0, "blocking": [],
...
{"id": "B1e", "title": "Fast carving never drops a cut", "round": "Round 1", "column": "done", "statusAuto": "merged:2026-09-24", "machine": "james-3080", "merged": "2026-09-24", "kind": "bug", "grade": "M", "origin": "B1c's test found the host silently drops a carve scoop while the previous piece's collision is still being built (20-620 ms), so quick carving loses cuts.", "raisedBy": "Ben", "summary": "Build a carved piece's collision after the piece is in place, so every scoop is carved.", "status": "Merged; every scoop is carved (20 of 20). For Ben to play: a carved body collides as its box during a stroke.", "parent": "B1", "blocking": [], "repairRounds": 0, "involved": [{"role": "researched", "model": "Claude Sonnet (subagent)", "machine": "james-3080"},
   {"role":"implemented","model":"Grok (grok-4.7-build)","machine":"james-3080"},
   {"role":"reviewed","model":"Claude Opus (orchestrator)","machine":"james-3080"}
 ]},
...
{"id": "D12", "title": "Needs Input: one list of everything waiting on a person", "round": "Round 1", "column": "todo", "kind": "feature", "grade": "M", "origin": "Only formal questions got a badge; rulings, playtests and checks to write with Ben sat in card statuses and went stale.", "raisedBy": "Ben", "summary": "Every wait becomes a question with a kind (decide, play, write, try) and who may answer; a Needs Input tab lists them oldest first with what each blocks, marked stale after 2 days.", "status": "Approved; starts after D11.", "parent": "D1", "prio": 2, "involved": []},
