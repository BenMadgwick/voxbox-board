...
{"id": "F10", "title": "Sculpt: carve, grow and restore", "round": "Round 1", "column": "doing", "statusAuto": "tasks:1/3", "machine": "james-3080", "kind": "feature", "grade": "L", "origin": "Ben, 24 September: he wanted the opposite of carve, adding voxels to an object, and then a way to put an object back how it was made.", "raisedBy": "Ben", "summary": "The carve tool becomes Sculpt: left button carves as now, right button grows the object where you point (in the paint colour, or copying the colour next to it), and Ctrl with the right button restores it towards the way it was made, shape and colour. Grown voxels only join on to what is already there, so nothing floats loose.", "status": "1 of 3 tasks done.", "repairRounds": 0, "involved": []},
...
{"id": "F31c", "title": "/qa-task and /qa-report (development builds only)", "round": "Round 1", "column": "todo", "kind": "feature", "grade": "M", "origin": "Part of F31.", "raisedBy": "Ben", "summary": "Type /qa-task to be handed a random test you have not had yet; type /qa-report and the test's name, with Tab to complete it, to record your answer in your own words. Only in development builds: the shop build does not contain these commands at all.", "status": "Approved: waits for F31a and F31b.", "parent": "F31", "blocking": ["F31d"], "repairRounds": 0, "involved": []},
