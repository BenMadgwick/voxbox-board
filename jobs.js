...
{"id": "F10", "title": "Sculpt: carve, grow and restore", "round": "Round 1", "column": "doing", "statusAuto": "tasks:2/3", "machine": "james-3080", "kind": "feature", "grade": "L", "origin": "Ben, 24 September: he wanted the opposite of carve, adding voxels to an object, and then a way to put an object back how it was made.", "raisedBy": "Ben", "summary": "The carve tool becomes Sculpt: left button carves as now, right button grows the object where you point (in the paint colour, or copying the colour next to it), and Ctrl with the right button restores it towards the way it was made, shape and colour. Grown voxels only join on to what is already there, so nothing floats loose.", "status": "2 of 3 tasks done.", "repairRounds": 0, "involved": []},
